...
class CmdVelSubscriber(Node):
    ...
    def get_uniform_circular_vel(self, msg):
        self.ccwdirection = msg.ccwdirection
        self.radius = msg.radius
        self.lin_vel = msg.lin_vel
        self.get_logger().info('Subscribed msgs!')
        self.get_logger().info(f'\tClockWise Direction: {msg.ccwdirection}')
    ...
    def publish_twist_msg(self):
        ...
        self.ang_z = (self.lin_x / (self.radius + _eps)) if self.ccwdirection == True else -(self.lin_x / (self.radius + _eps))
